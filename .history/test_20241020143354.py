...
image = image.resize((50, 50))# Remplacez par le chemin de votre image
logo = ImageTk.PhotoImage(image)

# Create a label for the logo and add the image to it
logo_label = tk.Label(root, image=logo)
logo_label.grid(row=0, column=0, padx=10, pady=10, sticky="nw")
image = Image.open("logo.jpg")  # Remplacez par le chemin de votre image
image = image.resize((50, 50))  # Redimensionnez l'image
logo = ImageTk.PhotoImage(image)
