...
root = tk.Tk()
root.title("Mon Application avec Logo")
# Charger l'image du logo
logo = PhotoImage(file="logo.jpg")  # Remplacez le chemin ici


# Load the logo image using PIL
image = Image.open("logo.jpg")  # Use your actual image path
logo = ImageTk.PhotoImage(image)

# Display the logo in the interface
