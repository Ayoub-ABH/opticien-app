...
style.configure("Red.TButton", background="red", foreground="whireredte", font=("Arial", 10, "bold"))
style.configure("Blue.TButton", background="blue", foreground="white", font=("Arial", 10, "bold"))
...
tree.grid(row=1, column=1, padx=10, pady=10, sticky="nsew")
