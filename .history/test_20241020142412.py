...
style = ttk.Style()
# Create a style for the "Ajouter Client" button with a red background
style.configure("Red.TButton", background="red", foreground="white")

# Apply the style to the "Ajouter Client" button
add_button = ttk.Button( text="Ajouter Client", command=lambda: open_add_client_window(root), style="Red.TButton")
